...
public class MoveController
{
    public static void MoveControl(Transform objTransform, Vector3 moveDir, float speed) {
        ...
        RigidMovePos(objTransform, objTransform.GetComponent<Rigidbody>(), moveDir, speed);
    }
    ...
    public static void RigidMovePos(Transform objTransform, Rigidbody rigidbody, Vector3 dir, float speed) {
        rigidbody.MovePosition(objTransform.position + new Vector3(dir.x, 0, dir.z).normalized * speed * Time.fixedDeltaTime);
